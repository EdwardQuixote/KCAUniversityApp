 ...
 */
public class AdapterRecyclerViewJournals extends RecyclerView.Adapter<AdapterRecyclerViewJournals.ViewHolderClass> {
    ...
    public AdapterRecyclerViewJournals(JSONArray jsonArray) {
        this.jaryDataArray = jsonArray;
    }

    @Override
    public AdapterRecyclerViewJournals.ViewHolderClass onCreateViewHolder(ViewGroup parent, int viewType) {

        vRVLayout = LayoutInflater.from(parent.getContext()).inflate(R.layout.rowlayout_recyclerview_journals, parent, false);
    ...
    @Override
    public void onBindViewHolder(AdapterRecyclerViewJournals.ViewHolderClass holder, int position) {
    ...
    public static class ViewHolderClass extends RecyclerView.ViewHolder {
        ...
        public ViewHolderClass(View itemView) {
            ...
            txtTitleEdVol = (TextView) itemView.findViewById(R.id.txtJournalsTitleEditionVolume);
            txtSubtitle = (TextView) itemView.findViewById(R.id.txtJournalsSubtitle);
            txtAuthor = (TextView) itemView.findViewById(R.id.txtJournalsAuthor);
            txtDate = (TextView) itemView.findViewById(R.id.txtJournalsDatePublished);
